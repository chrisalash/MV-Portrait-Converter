...
Easy way to do so is to download python latest (i recommend from the windows store) and run these 2 commands
...
3.) Open up a terminal and cd into the folder where the python script is with the following command "cd FILEPATH" (you can obtain the filepath by copying the top line of file explorer) (also don't keep the quotes)
